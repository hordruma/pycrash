...
def impc(i: int, impactNum: int, poi_veh2x: float, poi_veh2y: float,
   ...
   # heading angle of tangent impact direction in global frame
    ...
    if show_results:
        ...
        print(f"dx1: {impPointEdge[impactNum]['impact_points'][0]:0.2f}, dy1: {impPointEdge[impactNum]['impact_points'][1]:0.2f}")
        print(f'dx2: {poi_veh2x:0.2f}, dy2: {poi_veh2y:0.2f}')
        print('Post Impact:')
        print(f'Vx1: {veh1.model.vx[i] * 0.681818:0.1f} mph, Vy1: {veh1.model.vy[i] * 0.681818:0.1f} mph')
        print(f'Vx2: {veh2.model.vx[i] * 0.681818:0.1f} mph, Vy2: {veh2.model.vy[i] * 0.681818:0.1f} mph')
